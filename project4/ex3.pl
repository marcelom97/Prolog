...
update_record:-
	...
	write('Dwse neo onoma :'),read(On),nl,
	write('Dwse neo tmhma :'),read(Tm),nl,
	write('Dwse neo thlefwno :'),read(Thl),nl,
	write('Dwse nea lista mathimatwn :'),read(L),nl,
	tell('kb.pl'),
...
%--------------------------------------------------------
create_record:-
    write('Dwse onoma :'),read(On),nl,
	write('Dwse tmhma :'),read(Tm),nl,
	write('Dwse thlefwno :'),read(Thl),nl,
	write('Dwse lista mathimatwn :'),read(L),nl,
...
delete_record:-
    ...
    read(Z)	,
	write('tha diagrapsi to :'),write(Z),
