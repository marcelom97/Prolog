...
student(1, fullname(marcelo, mollaj), address(minoos, 42, 73103, irakleio), spoudes(teicrete, stef, pliroforiki, software)).
student(2, fullname(ilias, loure), address(kaminia, 65, 45452, rethimno), spoudes(teicrete, stef, pliroforiki, network)).
student(3, fullname(vasilis, mastrokostas), address(minoos, 88, 73104, aliveri), spoudes(teicrete, stef, pliroforiki, network)).
student(4, fullname(kostas, stergianis), address(estavromenous, 11, 68101, kavala), spoudes(teicrete, sdo, dioikisi, logistika)).
student(5, fullname(gianis, karagiannidis), address(stamatiou, 11, 25250, komotini), spoudes(teicrete, stef, pliroforiki, hardware)).